...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 1262.0, 501.0, 39.0, 22.0 ],
					"style" : "",
					"text" : "jit.bfg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 857.0, 486.0, 39.0, 22.0 ],
					"style" : "",
					"text" : "jit.bfg"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 840.0, 330.660461, 228.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "scramblr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 836.0, 190.703354, 248.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "rotatr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 862.799988, 550.0, 221.199997, 208.399994 ],
					"prototypename" : "pixl",
					"varname" : "viewr",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-42::obj-116" : [ "tilingprob", "tiling probatility", 0 ],
			"obj-40::obj-28" : [ "pictctrl[57]", "pictctrl[1]", 0 ],
			"obj-42::obj-110" : [ "pictctrl[53]", "pictctrl[1]", 0 ],
			...
			"obj-42::obj-107" : [ "pictctrl[55]", "pictctrl[1]", 0 ],
			"obj-42::obj-100" : [ "pictctrl[56]", "pictctrl[1]", 0 ],
			"obj-42::obj-8" : [ "FreqMode[15]", "FreqMode", 0 ],
			"obj-40::obj-78" : [ "x offset[1]", "x offset", 0 ],
			"obj-40::obj-74" : [ "pictctrl[58]", "pictctrl[1]", 0 ],
			"obj-42::obj-121" : [ "offsetprob", "offset probability", 0 ],
			"obj-42::obj-68" : [ "horizontal", "horizontal", 0 ],
			"obj-40::obj-19" : [ "range[4]", "range", 0 ],
			"obj-42::obj-29" : [ "vertical", "vertical", 0 ],
			"obj-42::obj-115" : [ "pictctrl[54]", "pictctrl[1]", 0 ],
			"obj-40::obj-26" : [ "pictctrl[60]", "pictctrl[1]", 0 ],
			"obj-42::obj-13" : [ "pictctrl[52]", "pictctrl[1]", 0 ],
			"obj-42::obj-14" : [ "range[3]", "range", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "vz.viewr.maxpat",
